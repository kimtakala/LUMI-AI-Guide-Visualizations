...
# Single GPU setup - no distributed training needed
...
wandb.init(
    ...
    name="1 GPU 1 Node Run",
    # track hyperparameters and run metadata
    config={
        "base_learning_rate": 0.001,
        "learning_rate": 0.001,
        "batch_size_per_gpu": 32,
        "effective_batch_size": 32,  # 32 * 1 GPU
        "architecture": "vit_b_16",
        "epochs": 10,
        "nodes": 1,
        "gpus": 1,
        "total_gpus": 1,
        "scaling_strategy": "single_gpu_baseline",
    },
)
...
torch.save(model.state_dict(), "lumi_vit_b16_single_gpu_1node_1gpu_trained_model.pth")
