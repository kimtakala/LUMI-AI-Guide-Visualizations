...
print(f"2 GPU DataParallel training on device: {device}")

print("Wandb init")
wandb.init(
    # set the wandb project where this run will be logged
    project="Wandb-visualization",
    name="2 GPU 1 Node Run",
    # track hyperparameters and run metadata
    config={
        "base_learning_rate": 0.001,
        "learning_rate": 0.001,
        "batch_size_per_gpu": 32,
        "effective_batch_size": 32 * 2,  # 32 * 2 GPUs
...
def train_model(
    ...
    world_size = 2  # DataParallel with 2 GPUs
...
torch.save(model.state_dict(), "lumi_vit_b16_dual_gpu_1node_2gpu_trained_model.pth")
